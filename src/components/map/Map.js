...
class Map extends React.Component {
  render() {
    const MyMapComponent = withScriptjs(withGoogleMap((props) =>
      <GoogleMap
        defaultZoom={15}
        defaultCenter={{ lat: -34.90189708687567, lng: -58.020177345208275 }}
      ...
      >
        {props.isMarkerShown && <Marker position={{ lat: -34.90189708687567, lng: -58.020177345208275 }} title="IBHER Pueblo Nuevo" />}
      </GoogleMap>
    ))
